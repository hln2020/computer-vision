        ...
        for step in range(self.start_resl, self.max_resl+2):
            ...
            for iter in tqdm(range(self.iter_start,(self.trns_tick+self.stab_tick)*int(ceil(len(self.dataset)/self.batch_size)))):
                ...
                #ORIGINAL BEGIN
                    ...
                    #hailie begin
                        #print("Size of x.data:", self.x.data.size())
                        #print("Size of z_x_gen.data:", self.z_x_gen.data.size())
                        #print("Shape of alpha:", alpha.shape if hasattr(alpha, 'shape') else "Scalar")
                    #hailie end
